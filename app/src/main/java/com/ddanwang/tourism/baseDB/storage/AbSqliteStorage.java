 ...
 */
package com.ddanwang.tourism.baseDB.storage;

import android.content.Context;

import com.ddanwang.tourism.baseDB.orm.dao.AbDBDaoImpl;
import com.ddanwang.tourism.baseDB.task.AbTaskItem;
import com.ddanwang.tourism.baseDB.task.AbTaskListListener;
import com.ddanwang.tourism.baseDB.task.AbTaskObjectListener;
import com.ddanwang.tourism.baseDB.task.AbTaskQueue;
...
public class AbSqliteStorage {
     ...
     * @param dao                         实现AbDBDaoImpl的Dao
     * @param paramDataInsertListListener 返回监听器
     */
     ...
     * @param dao                     实现AbDBDaoImpl的Dao
     * @param paramDataSelectListener 返回监听器
     */
     ...
     * @param entity                  实体类 设置了对象关系映射
     * @param dao                     实现AbDBDaoImpl的Dao
     * @param paramDataUpdateListener 返回监听器
     */
     ...
     * @param dao                     实现AbDBDaoImpl的Dao
     * @param paramDataDeleteListener 返回监听器
     */
